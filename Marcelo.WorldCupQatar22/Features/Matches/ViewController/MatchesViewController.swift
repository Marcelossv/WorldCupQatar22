...
class MatchesViewController: UIViewController{
    ...
    var groupB : [Matches] = [
       ...
       Matches(titleMatch: "GROUP B - AHMAD BIN ALI 🏟", homeName: "USA", visitName: "WAL", vs: "X", dataTimeMatch: "MON 21/11 - 14H00", imageH: #imageLiteral(resourceName: "United-States-Flag-icon"), imageV: #imageLiteral(resourceName: "Wales-Flag")),
       Matches(titleMatch: "GROUP B - AHMAD BIN ALI  🏟", homeName: "WAL", visitName: "IRA", vs: "X", dataTimeMatch: "FRI 25/11 - 17H00", imageH: #imageLiteral(resourceName: "Wales-Flag"), imageV: #imageLiteral(resourceName: "Iran-Flag-icon")),
       ...
       Matches(titleMatch: "GROUP B - AHMAD BIN ALI  🏟", homeName: "WAL", visitName: "ENG", vs: "X", dataTimeMatch: "TUE 29/11 - 14H00", imageH: #imageLiteral(resourceName: "Wales-Flag"), imageV: #imageLiteral(resourceName: "England-Flag-icon")),
    ...
    var groupD : [Matches] = [
       ...
       Matches(titleMatch: "GROUP D - AL JANOUB 🏟", homeName: "FRA", visitName: "AUS", vs: "X", dataTimeMatch: "TUE 22/11 - 14H00", imageH: #imageLiteral(resourceName: "France-Flag-icon"), imageV: #imageLiteral(resourceName: "Australia-Flag")),
       Matches(titleMatch: "GROUP D - AL JANOUB  🏟", homeName: "TUN", visitName: "AUS", vs: "X", dataTimeMatch: "SAT 26/11 - 05H00", imageH: #imageLiteral(resourceName: "Tunisia-Flag-icon"), imageV: #imageLiteral(resourceName: "Australia-Flag")),
       ...
       Matches(titleMatch: "GROUP D - AL JANOUB 🏟", homeName: "AUS", visitName: "DEN", vs: "X", dataTimeMatch: "WED 30/11 - 10H00", imageH: #imageLiteral(resourceName: "Australia-Flag"), imageV: #imageLiteral(resourceName: "Denmark-Flag-icon"))
    ]
    ...
    var groupE : [Matches] = [
       ...
       Matches(titleMatch: "GROUP E - AL THUMAMA 🏟", homeName: "SPA", visitName: "CR", vs: "X", dataTimeMatch: "WED 23/11 - 11H00", imageH: #imageLiteral(resourceName: "Spain-Flag-icon"), imageV: #imageLiteral(resourceName: "costaRica-Flag")),
       Matches(titleMatch: "GROUP E - AHMAD BIN ALI  🏟", homeName: "JPN", visitName: "CR", vs: "X", dataTimeMatch: "SUN 27/11 - 05H00", imageH: #imageLiteral(resourceName: "Japan-Flag-icon"), imageV: #imageLiteral(resourceName: "costaRica-Flag")),
       ...
       Matches(titleMatch: "GROUP E - AL BAYT 🏟", homeName: "CR", visitName: "GER", vs: "X", dataTimeMatch: "THURS 01/12 - 14H00", imageH: #imageLiteral(resourceName: "costaRica-Flag"), imageV: #imageLiteral(resourceName: "Germany-Flag-icon"))
    ]
