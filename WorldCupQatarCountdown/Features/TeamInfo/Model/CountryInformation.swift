    ...
    Group(
        ...
        countries: [
            CountryInformation(
                ...
                information: "Having secured their spot in Qatar with six games remaining in the Qualifiers, there is no doubt that Brazil have found consistency under Tite in recent years. Neymar remains the main attraction of the selection, but is now surrounded by young attacking talents such as Vinícius Jr., Richarlison and Rafinha, who are expected to ease the burden of player Neymar dependence, Brazil also has a strong defense with Marquinhos and two great goalkeepers Alisson and Ederson. Even so, the selection is very questioned if it will be able to compete with the best teams in Europe. Probable Team: (4-3-3) Alisson; Danilo, Thiago Silva, Marquinhos, Alex Sandro; Fred, Casemiro, Paquetá; Raphinha, Neymar, Vinicius Jr."
            ),
            CountryInformation(
                name: "Serbia",
                flag: UIImage(named: "serbiaFlag") ?? UIImage(),
                teamImage: UIImage(named: "serbiaTeam") ?? UIImage(),
                information: "Serbia surprised world football when they overtook Portugal in the final seconds of qualifying to secure an automatic berth in Qatar, and will do the same later this year. They certainly have the firepower to do so, with Dusan Vlahovic, Aleksandar Mitrovic and Luka Jovic leading an attack that has Dusan Tadic and Sergej Milinkovic-Savic in midfield. However, they have only had one clean sheet in eight games in the Qualifiers, so they will need to strengthen their defense throughout the competition. Probable Team:(3-4-1-2) V. Milinkovic-Savic; Veljkovic, Milenkovic, Pavlovic; Zivkovic, Lukic, S. Milinkovic-Savic, Kostic; Tadic; Mitrovic, Vlahovic."
            ),
            CountryInformation(
                name: "Switzerland",
                flag: UIImage(named: "switzerlandFlag") ?? UIImage(),
                teamImage: UIImage(named: "switzerlandTeam") ?? UIImage(),
                information: "Specialists in rankings for major tournaments, Switzerland did it again, and this time, they edged out Italy for an automatic spot in Qatar after leading their UEFA group. The change of coach does not appear to have crippled one of the most consistent squads in world football, and it will be the same old-timers, Xherdan Shaqiri, Granit Xhaka and Yann Sommer, who will once again be considered to lead the way for this team. Don't expect them to be emotional, but expect them to reach the round of 16. It's just what they do. Probable Team:(4-2-3-1) Sommer; Widmer, Akanji, Elvedi, Rodriguez; Freuler, Xhaka; Shaqiri, Sow, Vargas; Embolo."
            ),
            CountryInformation(
                name: "Cameroon",
                flag: UIImage(named: "cameroonFlag") ?? UIImage(),
                teamImage: UIImage(named: "cameroonTeam") ?? UIImage(),
                information: "Cameroon secured their third place in the African Cup of Nations with an impressive last-minute victory over Algeria in the World Cup play-offs to secure a spot in Qatar. While they may not be the star-studded team of previous generations, manager Rigobert Song appears to have found a winning formula in the first few months of 2022. Their hopes of breaking out of the groups likely hinge on veteran strikers Eric Maxim Choupo-Mouting, Vincent Aboubakar and Karl Toko Ekambi, as well as talented goalkeeper Andre Onana. Probable Team:(4-3-3) Onana; Fai, Castelletto, Nkoulou, Tolo; Hongla, Gouet, Ondoua; Mbeumo, Aboubakar, Toko Ekambi."
            )
        ]
    ),
    Group(
